...
#include "../../../qtsoap-2.6-opensource/examples/google/google.h"
...
const QMetaObjectExtraData Google::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Google::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Google,
      qt_meta_data_Google, &staticMetaObjectExtraData }
};
